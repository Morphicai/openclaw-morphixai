...
- 15 skill workflows covering GitLab, GitHub, Jira, Confluence, Outlook, Gmail, Notion, Figma, and more
...
- `release-workflow` skill — step-by-step release SOP with pre-flight checks
